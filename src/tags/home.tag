<home>
	...
	<div id="carouselSite" class="carousel slide container" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
					...
					<img src="imgs/img01.jpg" class="img-fluid d-block">
			 ...
			 <div class="carousel-item ">
					...
					<img src="imgs/img02.jpg" class="img-fluid d-block" >
			...
			<div class="carousel-item">
					...
					<img src="imgs/img03.jpg" class="img-fluid d-block">
	...
	<div class="card text-white bg-secondary my-4 text-center container">
		<div class="row">
			<div class="card-body">
